		...
		<div className="min-h-screen bg-slate-50 flex flex-col justify-center items-center p-6">
			...
			<div className="max-w-3xl text-center space-y-8">
				...
				<p className="text-xl text-slate-600 max-w-2xl mx-auto">
					Stop typing in Word templates. Fill a simple form, generate
					a print-ready PDF, and get back to running your school.
				</p>
				...
				<div className="grid grid-cols-1 md:grid-cols-3 gap-6 pt-12 text-left">
					<div className="bg-white p-6 rounded-xl shadow-sm border border-slate-100">
						...
						<p className="text-slate-600 text-sm">
							Fill the fields and see the PDF update instantly. No
							waiting, no loading spinners.
						</p>
					</div>
					<div className="bg-white p-6 rounded-xl shadow-sm border border-slate-100">
						<h3 className="font-bold text-lg text-slate-900 mb-2">
					...
					<div className="bg-white p-6 rounded-xl shadow-sm border border-slate-100">
						...
						<p className="text-slate-600 text-sm">
							Perfect A4 formatting. Just click print, stamp it,
